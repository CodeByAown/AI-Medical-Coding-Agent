  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "border border-[#1e2d4d] bg-[#0f1629] shadow-[0_20px_60px_rgba(0,0,0,0.8)] rounded-2xl",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-slate-400 hover:text-white hover:bg-[#141e35] transition-colors focus:outline-none">
        <X className="h-4 w-4" />
